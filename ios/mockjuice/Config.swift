...
enum Config {
    ...
    static let EXPO_PUBLIC_API_BASE_URL = ""
    static let EXPO_PUBLIC_AUTH_URL = ""
    static let EXPO_PUBLIC_FUNCTIONS_URL = ""
    static let EXPO_PUBLIC_TOOLKIT_SECRET_KEY = ""
    ...
    static let allValues: [String: String] = [
        ...
        "EXPO_PUBLIC_AUTH_URL": EXPO_PUBLIC_AUTH_URL,
        "EXPO_PUBLIC_FUNCTIONS_URL": EXPO_PUBLIC_FUNCTIONS_URL,
        "EXPO_PUBLIC_TOOLKIT_SECRET_KEY": EXPO_PUBLIC_TOOLKIT_SECRET_KEY,
